...
namespace NogometniKlubAPP.Extensions
{
    /// <summary>
    /// Klasa koja sadrži proširenja za NogometniKlub aplikaciju.
    /// </summary>
    public static class EdunovaExtensions
    {
        ...
        public static void AddNogometniKlubSwaggerGen(this IServiceCollection Services)
        {
            ...
            { // sgo je instanca klase SwaggerGenOptions
              // čitati https://devintxcontent.blob.core.windows.net/showcontent/Speaker%20Presentations%20Fall%202017/Web%20API%20Best%20Practices.pdf
                ...
                {
                    Title = "NogometniKlub API",
                    Version = "v1",
                    Contact = new Microsoft.OpenApi.Models.OpenApiContact()
                    {
                        Email = "lmatkovic00@gmail.com",
                        Name = "Luka Matkovic"
                    },
                    Description = "Ovo je dokumentacija za NogometniKlub API",
                    License = new Microsoft.OpenApi.Models.OpenApiLicense()
                    {
                        Name = "Licenca za nogometne klubove"
                    }
                };
                sgo.SwaggerDoc("v1", o);
        ...
        /// </summary>
        /// <param name="Services">Instanca IServiceCollection.</param>
        public static void AddNogometniKlubCORS(this IServiceCollection Services)
        {
        ...
        /// </summary>
        /// <param name="Services">Instanca IServiceCollection.</param>
        public static void AddNogometniKlubSecurity(this IServiceCollection Services)
        {
